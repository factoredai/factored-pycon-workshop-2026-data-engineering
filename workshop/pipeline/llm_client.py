...
def describe_mode() -> str:
    """One-line, human-readable statement of the active extraction mode."""
    provider = active_provider()
    if provider is None:
        return "MODE: CANNED (no API key found) -> using pre-recorded responses"
    return f"MODE: LIVE ({provider}) -> calling a real LLM"
