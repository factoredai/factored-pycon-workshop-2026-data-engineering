...
from workshop.pipeline.llm_client import describe_mode, extract_with_llm
...
if __name__ == "__main__":
    ...
    # Pick up a key from .env for this local run (Docker Compose does this on its own).
    # load_dotenv defaults to override=False, so a real shell export still wins.
    load_dotenv()
    print(describe_mode())
